# Bitcoin Pizza - Node Open Mining Portal

**[Click here for the official - Zcash® Zclassic, Bitcoin Pizza Stratum Mining Pool Installation Guide](https://zdeveloper.org/wiki:z-nomp_install)**

This is a Equihash mining pool based off of Node Open Mining Portal.

Donations for development are greatly appreciated!
  * BTC: 1MVFwHhm9DnqvHNUa85QsKeUrCPBWsQQjA
...
http://bitcoinpizza.cc:8080 - Bitcoin Pizza Pool
...
sudo n stable
git clone https://github.com/dagbpa/z-nomp-bitcoin-pizza.git z-nomp-bitcoin-pizza
cd z-nomp-bitcoin-pizza
npm update
npm install
```

##### Pool config
Take a look at the example json file inside the `pool_configs` directory. And change the
